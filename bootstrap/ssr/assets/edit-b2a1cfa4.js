import { unref, withCtx, createVNode, createTextVNode, toDisplayString, withModifiers, withDirectives, vModelSelect, openBlock, createBlock, Fragment, renderList, createCommentVNode, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-12 bg-gray"${_scopeId}><div class="max-w-7xl mx-auto sm:px-6 lg:px-8"${_scopeId}><div class="bg-gray-700 overflow-hidden shadow-sm max-w-2xl py-4 mx-auto sm:px-6 lg:px-4"${_scopeId}><div class="flex justify-between items-center"${_scopeId}><h3 class="font-bold text-lg text-white"${_scopeId}>Редактировать ${ssrInterpolate(props.product.name)}</h3><div class="flex space-x-2"${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$3, {
              ...
              disabled: unref(user).isAdmin === false,
              autofocus: ""
            }, null, _parent2, _scopeId));
            ...
            if (unref(form).attributesData) {
              ...
              ssrRenderList(unref(form).attributesData.attributes, (attribute, index) => {
                ...
                _push2(`</div><button class="ml-2 text-red-500 mt-6"${_scopeId}><img src="/img/Trash.png" alt="-" class="block h-10 w-auto m-auto"${_scopeId}></button></div>`);
              });
              _push2(`<!--]-->`);
            } else {
              _push2(`<!---->`);
                ...
                createVNode("div", { class: "max-w-7xl mx-auto sm:px-6 lg:px-8" }, [
                  createVNode("div", { class: "bg-gray-700 overflow-hidden shadow-sm max-w-2xl py-4 mx-auto sm:px-6 lg:px-4" }, [
                    createVNode("div", { class: "flex justify-between items-center" }, [
                      createVNode("h3", { class: "font-bold text-lg text-white" }, "Редактировать " + toDisplayString(props.product.name), 1),
                    ...
                    createVNode("form", {
                      ...
                      createVNode("div", null, [
                        ...
                        createVNode("div", null, [
                          unref(form).attributesData ? (openBlock(true), createBlock(Fragment, { key: 0 }, renderList(unref(form).attributesData.attributes, (attribute, index) => {
